...
pub fn parse_str_to_usize(input: &Option<String>, default: &Option<String>) -> Result<usize, Box<dyn Error>> {
    let input: String = match input {
        ...
        None => return Err(String::from("Failed to access setting properties.").into()),
    };
